        ...
        <div className="navbar-end">
          ...
          {user ? (
            <div className="dropdown dropdown-hover dropdown-end z-15 ml-2">
              ...
              >
                <div className="w-12 rounded-full ring ring-amber-400 ring-offset-base-100 ring-offset-2">
                  {" "}
                  <img
                    src={user.photoURL}
                    alt="User avatar"
              ...
              <ul
                tabIndex="-1"
                className="dropdown-content menu bg-base-100 rounded-box z-15 w-48 p-2 shadow-sm"
              >
                <li>
