...
const BookError = () => {
  return (
    <div className="flex flex-col justify-center items-center p-10 md:p-15">
      ...
      <p className="font-semibold 5xl mb-2">OPPS!! NO BOOK FOUND</p>
      <p className="font-light sm gray-600 mb-6">
        You haven't added any book on our system. please try to add a book
        first.
      </p>
    </div>
  );
